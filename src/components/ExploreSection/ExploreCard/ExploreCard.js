    ...
    return(
        <div className="explore-card cur-po">
            <div className="explore-card-cover">
                ...
                {goldoff && <div className="gold-off absoulte-center">{goldoff}</div>}
                {discount && <div className="discount absoulte-center">{discount}</div>}
            </div>
            <div className="res-row">
                <div className="res-name">{name}</div>
                {rating && ( <div className="res-rating absoulte-center"> {rating} <i class="fi fi-rs-star"></i></div> )}
            </div>
            <div className="res-row">
                {cuisines.length && (
